...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        MainWindow.setWindowTitle("CS PROJECT")
        ...
        self.help_button = QtWidgets.QPushButton("Toggle",self.frame)
...
"border-radius:7px")
        ...
        self.help_close.setGeometry(0,0,35,35)#help close button
        self.help_close.setObjectName("help_close")
        self.help_close.setStyleSheet("background-color: transparent ; border: none; border-radius:7px")
        ...
        self.help_close.setFocusPolicy(Qt.NoFocus)
